...
import org.streamreasoning.rsp4j.yasper.example_windowing.ValidatedGraph;
import org.streamreasoning.rsp4j.yasper.example_windowing.ValidatedGraphContentFactory;
...
public class Example {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Graph shapesGraph = RDFDataMgr.loadGraph(Example.class.getResource("/shapes.ttl").getPath());
